            ...
            "featuresHelp": {
                "configureHelp": {
                    ...
                    "text": "You identify your favourite RSS feeds, Twitter handles, Twitter hashtags and Facebook pages as sources. \
                            Group your sources into Categories and get an structured view of news updates."
                },
                "surfHelp": {
                    "name": "Surf",
                    "text": "MakeNews relays updates from sources. You do not have to go to every source to seek updates. \
                            Add sources in Configure then scroll infinitely through updates in Surf. Click on the item and it opens up in a new tab."
                },
                "parkHelp": {
                    "name": "Park",
                    "text": "Set aside interesting posts from the rush of news items in Surf. \
                            Parked items can be considered later or unparked and moved back to Surf."
                }
            }
        },
        "configurePage": {
